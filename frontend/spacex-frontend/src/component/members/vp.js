...
const VP = () => {
  ...
  const handleSave=()=>{
    ...
    axios.post('http://localhost:9091/spaceX/allocateSpace', {
      'empId':location.state.empId,
      'numberOfSeats':num,
      'sDate':startDate,
      'eDate':endDate,
                ...
                <div className="row">
                  <div className="col-md-12" style={{ backgroundColor: 'navy', padding: '10px,5px', color: 'white', padding: '4px' }}>
                    <Form.Group controlId="startDate">
                      ...
                      <Form.Control type="date" name="startDate" placeholder="Start Date"onChange={handleStart} />
                    </Form.Group>
                  </div>
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-md-12" style={{ backgroundColor: 'navy', padding: '10px,5px', color: 'white', padding: '4px' }}>
                    <Form.Group controlId="endDate">
                      ...
                      <Form.Control type="date" name="endDate" placeholder="End Date"onChange={handleEnd} />
                    </Form.Group>
                  </div>
                </div>
              </div>
      ...
      <div class="seatBox">
        <div class="row" style={{margin:0,padding:0,display:'flex',justifyContent:'space-between'}} >
          <div class="col=lg-6" style={{ width: "49%",boxShadow:'navy 1px 5px 8px 2px',borderRadius:'5px',margin:'2px' }}>
            <Seats wing="A" floor={floor} oecode={OEcode} seats={seatKey} empId={location.state.empId}></Seats>
          </div>
          <div class="col=lg-6" style={{ width: "49%", float: "left" ,boxShadow:'navy 1px 5px 8px 2px',borderRadius:'5px',margin:'2px'}}>
            <Seats wing="B" floor={floor} oecode={OEcode} seats={seatKey}empId={location.state.empId}></Seats>
          </div>
        ...
        <div class="row" style={{margin:0,padding:0,display:'flex',justifyContent:'space-between'}} >
          <div class="col=lg-6"style={{ width: "49%",boxShadow:'navy 1px 5px 8px 2px',borderRadius:'5px',margin:'2px' }}>
            <Seats wing="C" floor={floor} oecode={OEcode} seats={seatKey} empId={location.state.empId}></Seats>
          </div>
          <div class="col=lg-6" style={{ width: "49%",boxShadow:'navy 1px 5px 8px 2px',borderRadius:'5px',margin:'2px' }}>
            <Seats wing="D" floor={floor} oecode={OEcode} seats={seatKey} empId={location.state.empId}></Seats>
          </div>
